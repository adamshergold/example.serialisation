...
type Address = {
    Number : int32
    Street : string
    Region : Klarity.Serialisation.TestTypes.Example.Region
}
with
        ...
        { new ITypeSerialiser<Address>
            with
                ...
                member this.Deserialise (serialiser:ISerialiser) (stream:ISerialiserStream) =
                    ...
                    let _Region = 
                        bds.ReadEnum<Klarity.Serialisation.TestTypes.Example.Region>()                            
        ...
        { new ITypeSerialiser<Address>
            with
                ...
                member this.Deserialise (serialiser:ISerialiser) (stream:ISerialiserStream) =
                    ...
                    jds.Handlers.On "Region" ( jds.ReadEnum<Klarity.Serialisation.TestTypes.Example.Region> )
